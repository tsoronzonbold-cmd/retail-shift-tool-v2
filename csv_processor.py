...
def auto_detect_columns(df_columns):
    ...
    patterns = {
        ...
        "store_number": [r"store\s*#", r"store\s*num", r"store\s*no", r"location\s*#",
                         r"^store$", r"club\s*#", r"club\s*num", r"club\s*no",
                         r"^club$", r"^business$", r"business\s*name", r"^#$", r"^loc"],
        ...
        "quantity": [r"^quantity", r"#\s*of\s*worker", r"\bqty\b", r"headcount",
                     ...
                     r"#\s*of\s*pros", r"^pros$", r"^head.?ct$", r"hc\s*needed"],
        ...
        "team_lead": [r"on.?site\s*contact(?:\s*\(.*\))?$",
                      r"team\s*lead(?!\s*phone|\s*email)",
                      r"^contact$", r"^s\s*lead$", r"^slead$", r"^lead$",
