...
def auto_detect_columns(df_columns):
    ...
    mapping = {}
    patterns = {
        "retailer": [r"^retailer$", r"^retailer\s*name$", r"^chain$", r"^banner$", r"^store\s*name$"],
        ...
        "quantity": [r"^quantity", r"#\s*of\s*worker", r"\bqty\b", r"headcount", r"workers?\s*needed", r"^request$", r"^req$"],
        ...
        "team_lead": [r"on.?site\s*contact$", r"team\s*lead(?!\s*phone|\s*email)", r"^contact$", r"supervisor", r"^lead$"],
